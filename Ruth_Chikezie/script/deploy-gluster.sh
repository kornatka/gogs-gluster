...
if [ "$(hostname)" = "ruch3" ]; then
docker exec dymphna gluster peer probe gruch1
docker exec dymphna gluster peer probe gruch2

sleep 10
docker exec dymphna gluster volume create gv0 replica 3 gruch1:/data/gv0 gruch2:/data/gv0 gruch3:/data/gv0
